        ...
        <div className="p-6 border-b">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              { Icon: Clock, label: t('dashboard:detailSheet.jobDuration'), value: candidate.employmentDurationRaw ? tScreeningOption(candidate.employmentDurationRaw) : (candidate.employmentDuration >= 12 ? t('dashboard:detailSheet.jobDuration_years', { count: Math.floor(candidate.employmentDuration / 12) }) : t('dashboard:detailSheet.jobDuration_months', { count: candidate.employmentDuration })) },
